...
function toPercentMaybe(value: number | null): number | null {
...
export function normalizeBaselineResponse(response?: BaselineResponse | null): NormalizedBaselineOverview {
  ...
  normalized.pctPopulationWithin30Min = toPercentMaybe(normalized.pctPopulationWithin30Min);
  normalized.pctPopulationWithin60Min = toPercentMaybe(normalized.pctPopulationWithin60Min);
  normalized.coverageGapPct = toPercentMaybe(normalized.coverageGapPct);
  return normalized;
}
...
export function normalizeOverviewData({
  ...
  const normalizedOverview = {
    ...
    averageAccessTimeMin,
    averageAccessibilityScore,
    pctPopulationWithin60Min: toPercentMaybe(pctPopulationWithin60Min),
    coverageGapPct: toPercentMaybe(coverageGapPct),
